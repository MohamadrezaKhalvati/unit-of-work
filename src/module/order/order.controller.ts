...
export class OrdersController {
    ...
    @ApiResponse({
        status: 400,
        description: 'Bad Request (validation errors or insufficient stock)',
    })
    ...
    @ApiResponse({
        status: 200,
        description: 'The found order with its items and user.',
        type: Order,
    })
    ...
    @ApiOperation({
        summary: 'Cancel an order (demonstrates Unit of Work for rollback)',
    })
    @ApiResponse({
        status: 200,
